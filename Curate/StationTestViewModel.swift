...
//  replaced by the HybridRecommender in CandidatePool/HybridRecommender.swift.
//
//  This file is preserved for reference but commented out to avoid build errors.
//
...
@MainActor
@Observable
final class StationTestViewModel {
